...
class HomeController {
	...
	protected function view_login(){
		...
		$permissions = ['email']; 
		$loginUrl = $helper->getLoginUrl('http://localhost/safecity/index.php?c=auth&a=logueofc&d=login', $permissions);
		$out=$loginUrl;
	...
	protected function view_register(){
		...
		$helper = $fb->getRedirectLoginHelper();
		$permissions = ['email']; 
		$loginUrl = $helper->getLoginUrl('http://localhost/safecity/index.php?c=auth&a=logueofc&d=register', $permissions);
		$out=$loginUrl;
