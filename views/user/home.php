	...
	<div class="container banner text-center" style="padding-top: 90px;padding-bottom: 30px;">
		...
		<div class="row">
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail"  >
					<br>
					<img src="../../images/iconoinicio (2).png" width="24%" height="80px"/>
					<br>
					<div class="caption" style="background-color:#FE2E2E">
						<p><a href="javascript:alerta('<?php echo $_SESSION['id_auth']; ?>')" class="btn btn-default">Botón del pánico</a></p>
					</div>
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4">
				<div class="thumbnail">
				<br>
					<img src="../../images/registraralert (2).png" width="24%" height="80px"/>
					<br>
		...
		<div class="row">
			<div class="col-sm-6 col-md-4" >
				<div class="thumbnail" >
					<br>
					<img src="../../images/zona (2).png" width="20%" height="80px"/>
					<br>
